...
const highlights: [string[], chalk.Chalk][] = [
  ...
  [['entity', 'keyword', 'important', 'selector', 'tag', 'operator', 'arrow', 'alternation', 'quantifier', 'escape', 'special-escape', 'anchor', 'interpolation-punctuation', 'module'], chalk.magentaBright], // --pink
